...
{
    echo("<p>");
    $sql = make_sql_pay_back_item_add_for_qq($_POST["log_datetime1"],
        $_POST["log_datetime2"],
        $_POST["acct"],
        $_POST["char_name"],
        $_POST["excel_id"],
        "pay_back_item_add_for_qq");
    $sql1 = make_sql_pay_back_point_add_for_qq($_POST["log_datetime1"],
        $_POST["log_datetime2"],
        $_POST["acct"],
        $_POST["char_name"],
        $_POST["excel_id"],
        "pay_back_point_add_for_qq");
    $sql2 = make_sql_item($_POST["log_datetime1"],
        $_POST["log_datetime2"],
        $_POST["acct"],
        $_POST["char_name"],
        $_POST["excel_id"],
